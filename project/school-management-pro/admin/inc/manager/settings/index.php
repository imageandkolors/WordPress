...
$tickets_menu           = get_option('wlsm_tickets_menu');
$accounting_menu        = get_option('wlsm_accounting_menu');
				...
				<div class="tab-content" id="wlsm-tabs">
					<div class="ml-1 tab-pane fade show active" id="wlsm-general" role="tabpanel" aria-labelledby="wlsm-general-tab">
						...
						<form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wlsm-save-general-settings-form">
							...
							<div class="row">
								<div class="col-md-4">
									<label for="wlsm_disable_future_attendance" class="wlsm-font-bold">
										<?php esc_html_e('Attendance', 'school-management'); ?>:
									</label>
								</div>
								<div class="col-md-8">
									<div class="form-group">
										<input <?php checked($disable_future_attendance, 1, true); ?> class="form-check-input mt-1" type="checkbox" name="disable_future_attendance" id="wlsm_disable_future_attendance" value="1">
										<label class="ml-4 mb-1 form-check-label wlsm-font-bold text-secondary" for="wlsm_disable_future_attendance">
											<?php esc_html_e('Disable Future Attendance', 'school-management'); ?>
										</label>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-4">
								<label for="wlsm_tickets_menu" class="wlsm-font-bold">
									<?php esc_html_e('Tickets Menu show', 'school-management'); ?>:
								</label>
							</div>
							<div class="col-md-8">
								<div class="form-group">
									<input <?php checked($tickets_menu, 1, true); ?> class="form-check-input mt-1" type="checkbox" name="tickets_menu" id="wlsm_tickets_menu" value="1">
									<label class="ml-4 mb-1 form-check-label wlsm-font-bold text-secondary" for="wlsm_tickets_menu">
										<?php esc_html_e('Disable tickets Menu show on dashboard', 'school-management'); ?>
									</label>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-4">
								<label for="wlsm_accounting_menu" class="wlsm-font-bold">
									<?php esc_html_e('Accounting Menu show', 'school-management'); ?>:
								</label>
							</div>
							<div class="col-md-8">
								<div class="form-group">
									<input <?php checked($accounting_menu, 1, true); ?> class="form-check-input mt-1" type="checkbox" name="accounting_menu" id="wlsm_accounting_menu" value="1">
									<label class="ml-4 mb-1 form-check-label wlsm-font-bold text-secondary" for="wlsm_accounting_menu">
										<?php esc_html_e('Disable accounting Menu show on dashboard', 'school-management'); ?>
									</label>
								</div>
							</div>
						</div>							<div class="row">
								...
								<div class="col-md-8">
									<div class="form-group">
										<select name="theme_color" id="wlsm_theme_color" class="form-control">
											...
											<option <?php selected($theme_color, 'grey', true); ?> value="grey"><?php esc_html_e('Grey', 'school-management'); ?></option>
										</select>
									</div>
								</div>
							</div>
