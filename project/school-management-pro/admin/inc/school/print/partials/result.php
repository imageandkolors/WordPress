			...
			<div class="col-md-12">
				<div class="table-responsive w-100">
					...
					if ( isset( $exam->rank_criteria ) && 'section_wise' === $exam->rank_criteria ) {
						$student_section_id = $result->section_id;
					}
					$student_rank = WLSM_M_Staff_Examination::calculate_exam_ranks( $school_id, $exam_id, array(), $result->admit_card_id, true, $student_section_id );
					?>
					<thead>
						<tr>
