...
if ( ! WLSM_M_Role::can('view_payment_history') ) {
	die();
}
		...
		<div class="wlsm-table-block">
			...
			<div class="col-md-8">
					<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-fetch-payments-form" class="mb-3">
						...
						<input type="hidden" id="wlsm-print-bulk-collect-receipt-nonce" value="<?php echo esc_attr( wp_create_nonce( 'wlsm-print-bulk-collect-receipt' ) ); ?>">
