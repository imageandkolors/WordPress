	...
	<div class="col-md-12">
		...
		<form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wlsm-save-invoice-form">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-4 wlsm-student-select-block">
							...
							<div class="mt-2 wlsm-print-fee-structure-box">
								...
								<button type="button" class="btn btn-sm btn-outline-secondary wlsm-view-invoice-fee-details" data-nonce="<?php echo esc_attr(wp_create_nonce('view-invoice-fee-details')); ?>" data-only-one-student="<?php esc_attr_e('Please select only one student.', 'school-management'); ?>" data-url="<?php echo esc_url(add_query_arg(array('action' => 'fee_details'), $page_url)); ?>"><i class="fas fa-eye"></i> <?php esc_html_e('Fee Details', 'school-management'); ?></button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="wlsm-form-section" id="fee-section">
				...
				<div id="fees-box_list" class="wlsm-fees-box" data-fees-type-list="<?php echo !empty($fees) ? esc_attr(json_encode((array)$fees)) : ''; ?>" data-fee-type="<?php esc_attr_e('Fee Label', 'school-management'); ?>" data-fee-type-placeholder="<?php esc_attr_e('Enter fee label', 'school-management'); ?>" data-fee-period="<?php esc_attr_e('Period', 'school-management'); ?>" data-fee-amount="<?php esc_attr_e('Amount', 'school-management'); ?>" data-fee-amount-placeholder="<?php esc_attr_e('Enter amount', 'school-management'); ?>" data-fee-periods="<?php echo esc_attr(json_encode($fee_periods)); ?>">
							...
							<div class="wlsm-fee-box card col" data-fee="<?php echo esc_attr($index); ?>">
								...
								<div class="form-row">
									<div class="form-group col-md-4">
										...
										<input type="text" name="fee_label[]" class="form-control" ID="wlsm_fee_label_<?php echo esc_attr($index); ?>" placeholder="<?php esc_attr_e('Enter fee label', 'school-management'); ?>" value="<?php echo esc_attr(stripcslashes($fee->label)); ?>">
									</div>
									<div class="form-group col-md-4">
							...
							<div class="wlsm-fee-box card col" data-fee="1">
								...
								<div class="form-row">
									<div class="form-group col-md-4">
										...
										<input type="text" name="fee_label[]" class="form-control" placeholder="<?php esc_attr_e('Enter fee label', 'school-management'); ?>">
									</div>
									<div class="form-group col-md-4">
