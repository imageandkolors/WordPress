...
if ( ! WLSM_M_Role::can('view_income_category') ) {
	die();
}
			...
			<div>
				<span class="float-md-right">
					<button type="submit" class="btn btn-sm btn-primary" id="wlsm-save-income-category-btn">
						...
						<?php if ( $income_category ) { esc_html_e( 'Update Donation Category', 'school-management' ); } else { esc_html_e( 'Add Donation Category', 'school-management' ); } ?>
					</button>
				</span>
			</div>
