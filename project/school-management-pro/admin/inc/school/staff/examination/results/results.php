		...
		<div class="mt-3 text-center wlsm-section-heading-block">
			...
			<span class="float-md-right">
				...
				<?php if ( WLSM_M_Role::can('add_exam_results') ) : ?>
					...
					<a href="#" class="btn btn-sm btn-outline-light" id="wlsm-notify-exam-results-btn" data-exam="<?php echo esc_attr( $exam_id ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'notify-exam-results-' . $exam_id ) ); ?>">
						<i class="fas fa-bell"></i>&nbsp;
						<?php esc_html_e( 'Bulk Notify Results', 'school-management' ); ?>
					</a>
				<?php endif; ?>
			</span>
		</div>
