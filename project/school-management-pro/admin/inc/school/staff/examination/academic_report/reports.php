	...
	<div class="col-md-12">
		<div class="text-center wlsm-section-heading-block">
			...
			<span class="float-md-right">
				<button type="button" class="btn btn-sm btn-success wlsm-send-academic-report-sms-bulk" data-nonce="<?php echo esc_attr( wp_create_nonce( 'send-academic-report-sms-bulk-' . $report_id ) ); ?>" data-report="<?php echo esc_attr( $report_id ); ?>" data-message-title="<?php esc_attr_e( 'Confirm Bulk SMS Sending', 'school-management' ); ?>" data-message-content="<?php esc_attr_e( 'Are you sure you want to send SMS to all displayed students?', 'school-management' ); ?>" data-submit="<?php esc_attr_e('Send SMS to All', 'school-management'); ?>">
