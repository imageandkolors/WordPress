...
if ( WLSM_M_Role::check_permission( array( 'view_student_leaves' ), $current_school['permissions'] ) ) {
...
if ( WLSM_M_Role::check_permission( array( 'view_staff_leaves' ), $current_school['permissions'] ) ) {
...
<?php
$can_view_calendar = WLSM_M_Role::check_permission( array( 'view_events', 'view_attendance' ), $current_school['permissions'] );
$show_income_expense_chart = WLSM_M_Role::check_permission( array( 'view_income', 'view_expenses' ), $current_school['permissions'] ) && ( $settings_chart_enable['monthly_income_expense'] );
?>

<?php if ( $show_income_expense_chart || $can_view_calendar ) : ?>
<div class="row">
	<?php if ( $show_income_expense_chart ) : ?>
	<div class="col-md-6">
		<div class="wlsm-stats-heading-block">
			<div class="wlsm-stats-heading">
				<i class="fas fa-chart-line"></i> <?php esc_html_e( 'Monthly Donation and Expense', 'school-management' ); ?>
			</div>
		</div>
	...
	<?php if ( $can_view_calendar ) : ?>
	<div class="<?php echo $show_income_expense_chart ? 'col-md-6' : 'col-md-12'; ?>">
		<div class="wlsm-stats-heading-block">
			<div class="wlsm-stats-heading">
				<i class="fas fa-calendar-alt"></i> <?php esc_html_e( 'School Calendar', 'school-management' ); ?>
			</div>
		</div>
		<?php require_once WLSM_PLUGIN_DIR_PATH . 'admin/inc/school/staff/general/dashboard/calendar.php'; ?>
	</div>
	<?php endif; ?>
</div>
<?php endif; ?>
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="wlsm-stats-heading-block">
			<div class="wlsm-stats-heading">
				<i class="fas fa-users"></i> <?php esc_html_e( 'Monthly Admissions', 'school-management' ); ?>
			</div>
		</div>
		<div class="wlsm-table-block">
	...
	<div class="col-md-6">
		<div class="wlsm-stats-heading-block">
			<div class="wlsm-stats-heading">
				<i class="fas fa-file-invoice-dollar"></i> <?php esc_html_e( 'Monthly Payments', 'school-management' ); ?>
			</div>
		</div>
		<div class="wlsm-table-block">
