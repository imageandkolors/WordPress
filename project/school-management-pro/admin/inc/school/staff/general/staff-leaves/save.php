				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						...
						<div class="form-check form-check-inline">
							...
							<label class="ml-1 form-check-label text-warning font-weight-bold" for="wlsm_is_approved_0">
								<?php echo esc_html( WLSM_M_Staff_Class::get_unapproved_text() ); ?>
							</label>
						</div>
						<div class="form-check form-check-inline">
							<input <?php checked( 2, $is_approved, true ); ?> class="form-check-input" type="radio" name="is_approved" id="wlsm_is_approved_2" value="2">
							<label class="ml-1 form-check-label text-danger font-weight-bold" for="wlsm_is_approved_2">
								<?php echo esc_html( WLSM_M_Staff_Class::get_rejected_text() ); ?>
							</label>
						</div>
					</div>
				</div>
