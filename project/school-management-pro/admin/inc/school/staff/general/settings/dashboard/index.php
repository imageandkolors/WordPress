...
$school_fee_structure     = $settings_dashboard['school_fee_structure'];
$school_tickets           = $settings_dashboard['school_tickets'];
$school_calendar          = isset($settings_dashboard['school_calendar']) ? $settings_dashboard['school_calendar'] : 1;
$school_lessons           = isset($settings_dashboard['school_lessons']) ? $settings_dashboard['school_lessons'] : 0;
		...
		<div class="col-md-9">
			<form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wlsm-save-school-dashboard-settings-form">
				...
				<div class="text-center my-5">
					<h2><strong><?php esc_html_e('Student Dashboard Settings', 'school-management'); ?> </strong></h2>
				</div>
				...
				<div class="row">
					<div class="col-md-3">
						<label for="wlsm_calendar" class="wlsm-font-bold"><?php esc_html_e('Calendar', 'school-management'); ?>:</label>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<input <?php checked($school_calendar, true, true); ?> class="form-check-input mt-1" type="checkbox" name="calendar" id="wlsm_calendar" value="1">
							<label class="ml-4 mb-1 form-check-label wlsm-font-bold text-dark" for="wlsm_calendar">
								<?php esc_html_e("Show Calendar", 'school-management'); ?>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<label for="wlsm_lessons" class="wlsm-font-bold"><?php esc_html_e('Lessons', 'school-management'); ?>:</label>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<input <?php checked($school_lessons, true, true); ?> class="form-check-input mt-1" type="checkbox" name="lessons" id="wlsm_lessons" value="1">
							<label class="ml-4 mb-1 form-check-label wlsm-font-bold text-dark" for="wlsm_lessons">
								<?php esc_html_e("Show Lessons", 'school-management'); ?>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3">
						<label for="wlsm_fee_structure" class="wlsm-font-bold"><?php esc_html_e('Fee Structure', 'school-management'); ?>:</label>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<input <?php checked($school_fee_structure, true, true); ?> class="form-check-input mt-1" type="checkbox" name="fee_structure" id="wlsm_fee_structure" value="1">
							<label class="ml-4 mb-1 form-check-label wlsm-font-bold text-dark" for="wlsm_fee_structure">
								<?php esc_html_e("Show Fee Structure", 'school-management'); ?>
							</label>
						</div>
					</div>

					<div class="col-md-3">
						<label for="wlsm_tickets" class="wlsm-font-bold"><?php esc_html_e('Support Tickets', 'school-management'); ?>:</label>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<input <?php checked($school_tickets, true, true); ?> class="form-check-input mt-1" type="checkbox" name="tickets" id="wlsm_tickets" value="1">
							<label class="ml-4 mb-1 form-check-label wlsm-font-bold text-dark" for="wlsm_tickets">
								<?php esc_html_e("Show Support Tickets", 'school-management'); ?>
							</label>
						</div>
					</div>
				</div>
