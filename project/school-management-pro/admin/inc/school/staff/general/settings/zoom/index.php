	...
	<div class="row">
		...
		<div class="col-md-5">
			...
			<p>
				...
				?>
				<a target="_blank" href="https://docs.bigbluebutton.org/development/api/"><?php esc_html_e('Click here for more information', 'school-management'); ?></a>
				<a target="_blank" href="https://docs.biggerbluebutton.com/api/reference"><?php esc_html_e('BiggerBluebutton', 'school-management'); ?></a>
			</p>
		</div>
	</div>
