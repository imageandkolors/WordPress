...
// SMSLive247 settings.
$settings_smslive247            = WLSM_M_Setting::get_settings_smslive247($school_id);
$school_smslive247_api_key      = $settings_smslive247['api_key'];
$school_smslive247_sender_id    = $settings_smslive247['sender_id'];
...
// bulksms_sa settings.
$settings_bulksms_sa          = WLSM_M_Setting::get_settings_bulksms_sa($school_id);
$school_bulksms_sa_username   = $settings_bulksms_sa['username'];
$school_bulksms_sa_sender_id  = $settings_bulksms_sa['sender_id'];
...
// Pindo settings.
$settings_pindo       = WLSM_M_Setting::get_settings_pindo($school_id);
$school_pindo_api_token = $settings_pindo['api_token'];
$school_pindo_sender  = $settings_pindo['sender'];

// AfricasTalking settings.
$settings_africastalking = WLSM_M_Setting::get_settings_africastalking($school_id);
$school_africastalking_username = $settings_africastalking['username'];
$school_africastalking_api_key  = $settings_africastalking['api_key'];
$school_africastalking_sender_id = $settings_africastalking['sender_id'];
?>
	...
	<div class="row">
		<div class="col-md-9">
			<form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wlsm-save-school-sms-carrier-settings-form">
				...
				<div class="wlsm_sms_carrier wlsm_smslive247">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_smslive247_api_key" class="wlsm-font-bold"><?php esc_html_e('API Key', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="smslive247_api_key" type="text" id="wlsm_smslive247_api_key" value="<?php echo esc_attr($school_smslive247_api_key); ?>" class="form-control" placeholder="<?php esc_attr_e('SMSLive247 API Key', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_smslive247">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_smslive247_sender_id" class="wlsm-font-bold"><?php esc_html_e('Sender ID', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="smslive247_sender_id" type="text" id="wlsm_smslive247_sender_id" value="<?php echo esc_attr($school_smslive247_sender_id); ?>" class="form-control" placeholder="<?php esc_attr_e('SMSLive247 Sender ID', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>

				<div class="wlsm_sms_carrier wlsm_bulksms_sa">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_bulksms_sa_username" class="wlsm-font-bold"><?php esc_html_e('Username', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="bulksms_sa_username" type="text" id="wlsm_bulksms_sa_username" value="<?php echo esc_attr($school_bulksms_sa_username); ?>" class="form-control" placeholder="<?php esc_attr_e('Bulk SMS SA Username', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_bulksms_sa">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_bulksms_sa_password" class="wlsm-font-bold"><?php esc_html_e('Password', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="bulksms_sa_password" type="password" id="wlsm_bulksms_sa_password" class="form-control" placeholder="<?php esc_attr_e('Bulk SMS SA Password', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_bulksms_sa">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_bulksms_sa_sender_id" class="wlsm-font-bold"><?php esc_html_e('Sender ID', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="bulksms_sa_sender_id" type="text" id="wlsm_bulksms_sa_sender_id" value="<?php echo esc_attr($school_bulksms_sa_sender_id); ?>" class="form-control" placeholder="<?php esc_attr_e('Bulk SMS SA Sender ID', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_username" type="text" id="wlsm_nimratext_username" value="<?php echo esc_attr($school_nimratext_username); ?>" class="form-control" placeholder="<?php esc_attr_e(' username', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_sender_name" type="text" id="wlsm_nimratext_sender_name" value="<?php echo esc_attr($school_nimratext_sender_name); ?>" class="form-control" placeholder="<?php esc_attr_e(' sender name', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_sms_type" type="text" id="wlsm_nimratext_sms_type" value="<?php echo esc_attr($school_nimratext_sms_type); ?>" class="form-control" placeholder="<?php esc_attr_e(' sms type', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_api_key" type="text" id="wlsm_nimratext_api_key" value="<?php echo esc_attr($school_nimratext_api_key); ?>" class="form-control" placeholder="<?php esc_attr_e(' api key', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_peid" type="text" id="wlsm_nimratext_peid" value="<?php echo esc_attr($school_nimratext_peid); ?>" class="form-control" placeholder="<?php esc_attr_e(' peid', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_pindo">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_pindo_api_token" class="wlsm-font-bold"><?php esc_html_e('API Token', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="pindo_api_token" type="text" id="wlsm_pindo_api_token" value="<?php echo esc_attr($school_pindo_api_token); ?>" class="form-control" placeholder="<?php esc_attr_e('Pindo API Token', 'school-management'); ?>">
								<small class="form-text text-muted">
									<?php esc_html_e('Get your API token from your Pindo dashboard at', 'school-management'); ?>
									<a href="https://www.pindo.io/" target="_blank">https://www.pindo.io/</a>
								</small>
							</div>
						</div>
					</div>
				...
				<div class="wlsm_sms_carrier wlsm_pindo">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_pindo_sender" class="wlsm-font-bold"><?php esc_html_e('Sender Name', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="pindo_sender" type="text" id="wlsm_pindo_sender" value="<?php echo esc_attr($school_pindo_sender); ?>" class="form-control" placeholder="<?php esc_attr_e('Pindo Sender Name', 'school-management'); ?>">
								<small class="form-text text-muted">
									<?php esc_html_e('The name that will appear as the sender of your SMS messages', 'school-management'); ?>
								</small>
							</div>
						</div>
					</div>
				...
				<div class="wlsm_sms_carrier wlsm_africastalking">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_africastalking_username" class="wlsm-font-bold"><?php esc_html_e('Username', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="africastalking_username" type="text" id="wlsm_africastalking_username" value="<?php echo esc_attr($school_africastalking_username); ?>" class="form-control" placeholder="<?php esc_attr_e('AfricasTalking Username', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_africastalking">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_africastalking_api_key" class="wlsm-font-bold"><?php esc_html_e('API Key', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="africastalking_api_key" type="text" id="wlsm_africastalking_api_key" value="<?php echo esc_attr($school_africastalking_api_key); ?>" class="form-control" placeholder="<?php esc_attr_e('AfricasTalking API Key', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_africastalking">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_africastalking_sender_id" class="wlsm-font-bold"><?php esc_html_e('Sender ID', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="africastalking_sender_id" type="text" id="wlsm_africastalking_sender_id" value="<?php echo esc_attr($school_africastalking_sender_id); ?>" class="form-control" placeholder="<?php esc_attr_e('AfricasTalking Sender ID', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
