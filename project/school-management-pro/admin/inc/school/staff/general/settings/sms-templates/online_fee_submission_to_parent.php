...
$sms_online_fee_submission_to_parent_to_student = $settings_sms_online_fee_submission_to_parent['to_student'];
$sms_online_fee_submission_to_parent_to_father  = $settings_sms_online_fee_submission_to_parent['to_father'];
$sms_online_fee_submission_to_parent_to_mother  = $settings_sms_online_fee_submission_to_parent['to_mother'];
		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="form-check form-check-inline">
					<input <?php checked( $sms_online_fee_submission_to_parent_to_student, true, true ); ?> class="form-check-input" type="checkbox" name="sms_online_fee_submission_to_parent_to_student" id="wlsm_sms_online_fee_submission_to_parent_to_student" value="1">
					<label class="form-check-label wlsm-font-bold" for="wlsm_sms_online_fee_submission_to_parent_to_student">
						<?php esc_html_e( 'Student', 'school-management' ); ?>
					</label>
				</div>
				<div class="form-check form-check-inline">
					<input <?php checked( $sms_online_fee_submission_to_parent_to_father, true, true ); ?> class="form-check-input" type="checkbox" name="sms_online_fee_submission_to_parent_to_father" id="wlsm_sms_online_fee_submission_to_parent_to_father" value="1">
					<label class="form-check-label wlsm-font-bold" for="wlsm_sms_online_fee_submission_to_parent_to_father">
						<?php esc_html_e( 'Father', 'school-management' ); ?>
					</label>
				</div>
				<div class="form-check form-check-inline">
					<input <?php checked( $sms_online_fee_submission_to_parent_to_mother, true, true ); ?> class="form-check-input" type="checkbox" name="sms_online_fee_submission_to_parent_to_mother" id="wlsm_sms_online_fee_submission_to_parent_to_mother" value="1">
					<label class="form-check-label wlsm-font-bold" for="wlsm_sms_online_fee_submission_to_parent_to_mother">
