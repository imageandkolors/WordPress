				...
				<div class="form-row">
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							<input <?php checked($join_before_host, 1, true); ?> class="form-check-input mt-1" type="checkbox" name="join_before_host" id="wlsm_join_before_host" value="1">
							<label class="ml-4 mb-1 form-check-label" for="wlsm_join_before_host">
								<?php esc_html_e('Wait for moderator', 'school-management'); ?>
							</label>
							<p class="description ml-4"><?php esc_html_e('Students wait for host to start.', 'school-management'); ?></p>
						</div>
						...
						<div class="form-group">
							...
							<label class="ml-4 mb-1 form-check-label" for="wlsm_recordable">
								<?php esc_html_e('Allow Recording', 'school-management'); ?>
							</label>
							<p class="description ml-4"><?php esc_html_e('Meeting can be recorded.', 'school-management'); ?></p>
						</div>

						<div class="form-group">
							<input class="form-check-input mt-1" type="checkbox" name="lock_note" id="wlsm_lock_note" value="1">
							<label class="ml-4 mb-1 form-check-label" for="wlsm_lock_note">
								<?php esc_html_e('Disable Shared Notes', 'school-management'); ?>
							</label>
						</div>
					</div>
					...
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							<input class="form-check-input mt-1" type="checkbox" name="lock_private_chat" id="wlsm_lock_private_chat" value="1">
							<label class="ml-4 mb-1 form-check-label" for="wlsm_lock_private_chat">
								<?php esc_html_e('Disable Private Chat', 'school-management'); ?>
							</label>
						</div>

						<div class="form-group">
							<input class="form-check-input mt-1" type="checkbox" name="lock_public_chat" id="wlsm_lock_public_chat" value="1">
							<label class="ml-4 mb-1 form-check-label" for="wlsm_lock_public_chat">
								<?php esc_html_e('Disable Public Chat', 'school-management'); ?>
							</label>
						</div>

						<div class="form-group">
							<input class="form-check-input mt-1" type="checkbox" name="lock_cam" id="wlsm_lock_cam" value="1">
							<label class="ml-4 mb-1 form-check-label" for="wlsm_lock_cam">
								<?php esc_html_e('Disable Webcams', 'school-management'); ?>
							</label>
						</div>

						<div class="form-group">
							<input class="form-check-input mt-1" type="checkbox" name="lock_mic" id="wlsm_lock_mic" value="1">
							<label class="ml-4 mb-1 form-check-label" for="wlsm_lock_mic">
								<?php esc_html_e('Disable Microphones', 'school-management'); ?>
							</label>
						</div>
					</div>
				</div>
...
<style>
	...
	<?php if ($meeting && $meeting->class_type === 'bbb_class'): ?>#zoom_optional,
	#class_approval_type,
	#recurrence_type {
		display: none;
	}

	<?php else: ?>#bbb_optional,
	#class_moderator,
	#class_viewer {
		display: none;
	}
