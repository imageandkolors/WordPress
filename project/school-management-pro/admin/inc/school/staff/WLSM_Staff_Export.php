	...
	public static function student_sample_csv_export()
	{
		...
		try {
			...
			$fields = array(
				...
				esc_html__('Password', 'school-management'),
				esc_html__('Transport Route Name (optional)', 'school-management'),
				esc_html__('Transport Vehicle Number (optional)', 'school-management'),
			);
			...
			$sample_record = array(
				'Andrew Smith',
				'100001',
				esc_html(WLSM_Config::get_date_text(date('Y-m-d'))),
				...
				'', // Parent Username
				'', // Parent Password
				'', // Transport Route Name - e.g. "Route A" (leave blank for no transport)
				'', // Transport Vehicle Number - e.g. "MH-01-AB-1234" (leave blank for no transport)
			);
