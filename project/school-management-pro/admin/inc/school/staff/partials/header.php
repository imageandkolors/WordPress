...
$settings_general = WLSM_M_Setting::get_settings_general( $current_school['id'] );
$school_logo_id   = $settings_general['school_logo'];
$school_logo_url  = $school_logo_id ? wp_get_attachment_image_url( $school_logo_id, 'medium' ) : '';
?>
<div class="wlsm-main-header card col">
	<div class="">
		<h1 class="h3 text-center">
			<?php if ( $school_logo_url ) : ?>
				<img src="<?php echo esc_url( $school_logo_url ); ?>" class="wlsm-school-logo-header">
			<?php else : ?>
