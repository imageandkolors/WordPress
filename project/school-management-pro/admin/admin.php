...
require_once WLSM_PLUGIN_DIR_PATH . 'admin/inc/school/staff/gate-pass/WLSM_Staff_Gate_Pass.php';
...
add_action('wp_ajax_wlsm-fetch-class-house', array('WLSM_Staff_Class', 'fetch_class_house'));
add_action('wp_ajax_wlsm-save-house', array('WLSM_Staff_Class', 'save_house'));
add_action('wp_ajax_wlsm-delete-house', array('WLSM_Staff_Class', 'delete_house'));
...
// Staff: Get students for printing.
add_action('wp_ajax_wlsm-get-students-printing', array('WLSM_Staff_General', 'fetch_students_printing_ajax'));

// Staff: Print Selected ID Cards.
add_action('wp_ajax_wlsm-print-selected-id-cards', array('WLSM_Staff_General', 'print_selected_id_cards'));
...
add_action('wp_ajax_wlsm-attendance-class-report', array('WLSM_Staff_Class', 'attendance_class_report'));
...
// Staff: ID Cards.
add_action('wp_ajax_wlsm-fetch-id-cards', array('WLSM_Staff_General', 'fetch_id_cards_ajax'));
add_action('wp_ajax_wlsm-save-id-card', array('WLSM_Staff_General', 'save_id_card_ajax'));
add_action('wp_ajax_wlsm-delete-id-card', array('WLSM_Staff_General', 'delete_id_card_ajax'));
...
// Staff: Holidays.
add_action('wp_ajax_wlsm-fetch-holidays', array('WLSM_Staff_Class', 'fetch_holidays'));
add_action('wp_ajax_wlsm-save-holiday', array('WLSM_Staff_Class', 'save_holiday'));
add_action('wp_ajax_wlsm-delete-holiday', array('WLSM_Staff_Class', 'delete_holiday'));

// Staff: Calendar (Events + Holidays combined view).
add_action('wp_ajax_wlsm-fetch-calendar-events', array('WLSM_Staff_Class', 'fetch_calendar_events'));
...
add_action('wp_ajax_wlsm-save-academic-multi-group-report', array('WLSM_Staff_Examination', 'save_academic_multi_group_report'));
add_action('wp_ajax_wlsm-fetch-academic-multi-group-report', array('WLSM_Staff_Examination', 'fetch_academic_multi_group_report'));
add_action('wp_ajax_wlsm-delete-academic-multi-group-report', array('WLSM_Staff_Examination', 'delete_academic_multi_group_report'));
...
add_action('wp_ajax_wlsm-send-academic-report-sms', array('WLSM_Staff_Examination', 'send_academic_report_sms'));
add_action('wp_ajax_wlsm-send-academic-multi-group-report-sms', array('WLSM_Staff_Examination', 'send_academic_multi_group_report_sms'));
add_action('wp_ajax_wlsm-send-academic-report-sms-bulk', array('WLSM_Staff_Examination', 'send_academic_report_sms_bulk'));
add_action('wp_ajax_wlsm-send-academic-multi-group-report-sms-bulk', array('WLSM_Staff_Examination', 'send_academic_multi_group_report_sms_bulk'));
...
add_action('wp_ajax_wlsm-notify-exam-results', array('WLSM_Staff_Examination', 'notify_exam_results'));
...
add_action('wp_ajax_wlsm-get-academic-multi-group-report', array('WLSM_Staff_Examination', 'get_academic_multi_group_report'));
...
add_action('wp_ajax_wlsm-view-homework-submission', array('WLSM_Staff_Class', 'view_homework_submission'));
...
// Staff: Transport Invoices.
add_action('wp_ajax_wlsm-get-transport-invoices', array('WLSM_Staff_Accountant', 'get_transport_invoices'));
add_action('wp_ajax_wlsm-get-transport-students', array('WLSM_Staff_Accountant', 'get_transport_students'));
add_action('wp_ajax_wlsm-generate-transport-invoices', array('WLSM_Staff_Accountant', 'generate_transport_invoices'));
add_action('wp_ajax_wlsm-submit-bulk-collect-transport', array('WLSM_Staff_Accountant', 'submit_bulk_collect_transport'));
add_action('wp_ajax_wlsm-submit-bulk-collect-fee', array('WLSM_Staff_Accountant', 'submit_bulk_collect_fee'));
add_action('wp_ajax_wlsm-print-bulk-collect-receipt', array('WLSM_Staff_Accountant', 'print_bulk_collect_receipt'));
add_action('wp_ajax_wlsm-assign-student-transport', array('WLSM_Staff_Accountant', 'assign_student_transport'));
add_action('wp_ajax_wlsm-fetch-transport-route-vehicles', array('WLSM_Staff_Accountant', 'fetch_transport_route_vehicles'));

// Staff: Invoices.
add_action('wp_ajax_wlsm-get-invoices', array('WLSM_Staff_Accountant', 'get_invoices'));
add_action('wp_ajax_wlsm-get-student-finance-summary', array('WLSM_Staff_Accountant', 'get_student_finance_summary'));
...
add_action('wp_ajax_wlsm-view-invoice-fee-details', array('WLSM_Staff_Accountant', 'view_invoice_fee_details'));
...
// Staff: Gate Pass.
add_action('wp_ajax_wlsm-fetch-gate-passes', array('WLSM_Staff_Gate_Pass', 'fetch_gate_passes'));
add_action('wp_ajax_wlsm-save-gate-pass', array('WLSM_Staff_Gate_Pass', 'save_gate_pass'));
add_action('wp_ajax_wlsm-delete-gate-pass', array('WLSM_Staff_Gate_Pass', 'delete_gate_pass'));
add_action('wp_ajax_wlsm-print-gate-pass', array('WLSM_Staff_Gate_Pass', 'print_gate_pass'));
add_action('wp_ajax_wlsm-view-gate-pass-student', array('WLSM_Staff_Gate_Pass', 'view_gate_pass_student'));
add_action('wp_ajax_wlsm-upload-visitor-photo', array('WLSM_Staff_Gate_Pass', 'upload_visitor_photo'));
