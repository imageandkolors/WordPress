...
$school_registration_guardian_login    	= '';
...
if (isset($attr['school_id'])) {
	...
	$school_registration_guardian_login    = $settings_registration['guardian_login'];
	...
	$school_registration_house             = $settings_registration['house'];
	...
	$school_registration_house = false;
...
<div class="wlsm wlsm-grid">
	<div id="wlsm-submit-registration-section">
		...
		<form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wlsm-submit-registration-form">
				...
				<div class="wlsm-registration-section-content">
					<div class="wlsm-row">
						<div class="wlsm-form-group wlsm-col-4">
							...
							<input type="text" name="first_name" class="wlsm-form-control" id="wlsm_first_name" placeholder="<?php esc_attr_e('Enter first name', 'school-management'); ?>" value="">
						</div>
						<div class="wlsm-form-group wlsm-col-4">
							<label for="wlsm_middle_name" class="wlsm-font-bold">
								<?php esc_html_e('Middle Name', 'school-management'); ?>:
							</label>
							<input type="text" name="middle_name" class="wlsm-form-control" id="wlsm_middle_name" placeholder="<?php esc_attr_e('Enter middle name', 'school-management'); ?>" value="">
						</div>
						<div class="wlsm-form-group wlsm-col-4">
							<label for="wlsm_last_name" class="wlsm-font-bold">
								<span class="wlsm-important">*</span> <?php esc_html_e('Last Name', 'school-management'); ?>:
							</label>
							<input type="text" name="last_name" class="wlsm-form-control" id="wlsm_last_name" placeholder="<?php esc_attr_e('Enter last name', 'school-management'); ?>" value="">
						</div>
			...
			<div class="wlsm-registration-section" id="registration_admission_detail">
				...
				<div class="wlsm-registration-section-content">
					...
					<div class="wlsm-row">
						...
						<?php if ($school_registration_house or empty($school_id)) : ?>
							<div class="wlsm-form-group wlsm-col-4" id="registration_house">
								<label for="wlsm_house" class="wlsm-font-bold">
									<?php esc_html_e('House', 'school-management'); ?>:
								</label>
								<select name="house" class="wlsm-form-control selectpicker" id="wlsm_house" data-live-search="true">
			...
			<?php if ($school_registration_guardian_login or empty($school_id)) : ?>
				<div class="wlsm-registration-section" id="registration_guardian_login">
					<div class="wlsm-registration-section-header">
						<h3 class="wlsm-registration-section-title">
					...
					<div class="wlsm-registration-section-content">
						<div class="wlsm-row">
							<div class="wlsm-col-12">
								<div class="wlsm-form-group wlsm-row wlsm-mb-2">
									<input type="checkbox" name="allow_guardian_login" id="wlsm_allow_guardian_login" class="wlsm-mt-1 wlsm-mr-1" value="1" disabled>
									<label class="wlsm-font-bold wlsm-d-i-block wlsm-ml-1" for="wlsm_allow_guardian_login" style="opacity: 0.6;">
										<?php esc_html_e('Allow Guardian Login?', 'school-management'); ?>
										<small class="wlsm-text-muted"><?php esc_html_e('(Enable student login first)', 'school-management'); ?></small>
									</label>
								</div>
							</div>
						...
						<div class="wlsm-guardian-new-user">
							<div class="wlsm-row">
								<div class="wlsm-form-group wlsm-col-4">
									<label for="wlsm_guardian_username" class="wlsm-font-bold">
										<span class="wlsm-important">*</span> <?php esc_html_e('Username', 'school-management'); ?>:
									</label>
									<input type="text" name="guardian_username" class="wlsm-form-control" id="wlsm_guardian_username" placeholder="<?php esc_attr_e('Enter username', 'school-management'); ?>">
								</div>
								...
								<div class="wlsm-form-group wlsm-col-4">
									...
									<input type="email" name="guardian_login_email" class="wlsm-form-control" id="wlsm_guardian_login_email" placeholder="<?php esc_attr_e('Enter login email', 'school-management'); ?>">
								</div>
								...
								<div class="wlsm-form-group wlsm-col-4">
									...
									<input type="password" name="guardian_password" class="wlsm-form-control" id="wlsm_guardian_login_password" placeholder="<?php esc_attr_e('Enter password', 'school-management'); ?>">
								</div>
							</div>
						</div>
					</div>
