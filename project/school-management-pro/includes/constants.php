...
define( 'WLSM_ID_CARDS', $wpdb->prefix . 'wlsm_id_cards' );
...
define( 'WLSM_HOUSE', $wpdb->prefix . 'wlsm_house' );
...
define( 'WLSM_ACADEMIC_MULTI_GROUP_REPORTS', $wpdb->prefix . 'wlsm_academic_multi_group_reports' );
...
define( 'WLSM_MENU_STAFF_CUSTOM_ID_CARDS', 'sm-staff-custom-id-cards' );
...
define( 'WLSM_MENU_STAFF_CALENDAR', 'sm-staff-calendar' );
...
define( 'WLSM_MENU_STAFF_HOUSE', 'sm-staff-house' );
...
define( 'WLSM_MENU_STAFF_TRANSPORT_INVOICES', 'sm-staff-transport-invoices' );
...
// Gate Pass
define( 'WLSM_MENU_STAFF_GATE_PASSES', 'sm-staff-gate-passes' );
...
define( 'WLSM_MENU_STAFF_ACADEMIC_MULTI_GROUP_REPORT', 'sm-staff-academic-multi-group-report' );
...
define( 'WLSM_GATE_PASSES', $wpdb->prefix . 'wlsm_gate_passes' );

define( 'WLSM_HOLIDAYS', $wpdb->prefix . 'wlsm_holidays' );
define( 'WLSM_MENU_STAFF_HOLIDAYS', 'sm-staff-holidays' );
